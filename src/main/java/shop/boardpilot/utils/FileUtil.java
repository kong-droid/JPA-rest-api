...
public class FileUtil {
    ...
    public static String removeFile(Map<String, Object> fileMap) throws IOException {
        File file = new File(String.valueOf("fullPath"));
        if(file.exists()) {
            file.delete();
        } else {
            new NoSuchFileException(String.valueOf("fullPath"), CommonCode.RESOURCE_NOT_FOUND_CODE, "Not Found");
        }
        return "success";
    }
